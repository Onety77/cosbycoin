...
const App = () => {
  ...
  const architectMeme = async () => {
    ...
    try {
      ...
      8. On top of that whole Newly drawn background, write "MAKE IT RIGHT", ugly handwriting, hand drawn vibes, fiting color with a white stroke around the letters, make it fun, sketchy and match the background vibes.
