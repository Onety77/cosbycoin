...
const App = () => {
  ...
  const architectMeme = async () => {
    ...
    try {
      ...
      8. On top of that Newly drawn background, write "MAKE IT RIGHT", ugly handwriting, hand drawn vibes, fiting color, make it fun, sketchy and match the background vibes.
