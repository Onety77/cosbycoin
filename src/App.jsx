...
const App = () => {
  ...
  const architectMeme = async () => {
    ...
    try {
      ...
      4. Completely discard the original background of Image 1.
Re-draw the entire background from scratch on the Image 2 canvas in a messy, hand-drawn digital sketch style.
The final background must look uniformly illustrated across the entire frame, with no photorealistic areas, no preserved textures, and no visible remnants of the original image.
It should feel artistic, imperfect, and sketchy — not like a photo that was extended — and must fill the whole frame.
